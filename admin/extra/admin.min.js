...
+function (a) {
	...
	var c = 'lte.boxrefresh', d = {
			...
			if (this.element = b, this.options = c, this.$overlay = a(c.overlay), '' === c.source)
	...
	g.prototype.activate = function () {
		...
		var b = a(e.mainFooter).outerHeight() || 0, c = a(e.mainHeader).outerHeight() + b, d = a(window).height(), g = a(e.sidebar).height() || 0;
